...
export interface RenterHomeVehiclePreview { name: string; image: string; seats: number; transmission: string; price: number; duration: string; badge: string; }
export interface RenterReviewPreview { name: string; avatar: string; rating: number; comment: string; date: string; }

@Injectable({ providedIn: 'root' })
export class RenterHomeContentService {
  readonly store = {
  ...
  readonly vehiclePreviews: RenterHomeVehiclePreview[] = [
  ...
  readonly reviewPreviews: RenterReviewPreview[] = [
