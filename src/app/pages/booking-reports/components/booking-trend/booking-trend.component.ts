...
export class BookingTrendComponent {
  trend: TrendPoint[] = [
    { month: "Jan '25", value: 1520 },
    { month: "Feb '25", value: 1768 },
    { month: "Mar '25", value: 0 },
    { month: "Apr '25", value: 2185 },
    { month: "May '25", value: 2416 }
  ];
  ...
  get chartPoints(): ChartPoint[] {
    ...
    return this.trend.map((item, index) => {
      ...
      const y = this.chartBottomY - percentage * (this.chartBottomY - this.chartTopY);
